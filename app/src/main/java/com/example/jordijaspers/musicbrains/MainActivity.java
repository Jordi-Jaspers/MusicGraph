...
public class MainActivity extends AppCompatActivity {
    ...
    public void createSearchQuery(String subjectSearch) {
        ...
        URL SearchURL = com.example.jordijaspers.musicbrains.NetworkUtils.buildUrl(input, subjectSearch);
    ...
    public class QueryTasks extends AsyncTask<URL, Void, String> {
        ...
        protected String doInBackground(URL[] urls) {
            ...
            String searchResults = null;
            try{
                searchResults = com.example.jordijaspers.musicbrains.NetworkUtils.getResponseFromHttpUrl(createdURL);
            } catch (IOException e){
                e.printStackTrace();
            }
